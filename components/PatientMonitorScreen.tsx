  ...
  const navigate = useNavigate();
    ...
    return (
        <div className={`min-h-screen bg-gradient-to-br ${theme.background}`}>
            {/* Modern Header */}
            <div className={`bg-gradient-to-r ${theme.accent} px-4 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 flex justify-between items-center shadow-2xl relative overflow-hidden`}>
