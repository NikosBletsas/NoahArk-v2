...
const PatientEditForm: React.FC<PatientEditFormProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
      <div
        className={`${theme.card} backdrop-blur-lg rounded-xl shadow-2xl border border-white/20 w-full max-w-7xl max-h-[98vh] md:max-h-[90vh] lg:max-h-[85vh] overflow-hidden`}
      >
        {/* Header */}
        <div
          className={`bg-gradient-to-r ${theme.accent} ${theme.textOnAccent} p-3 sm:p-4 lg:p-5 flex justify-between items-center shrink-0`}
        >
        ...
        <div className="p-3 sm:p-4 lg:p-6 overflow-y-auto max-h-[calc(98vh-120px)] md:max-h-[calc(90vh-120px)] lg:max-h-[calc(85vh-130px)]">
          <div className="space-y-4 md:space-y-5 lg:space-y-6">
            ...
            <div className="space-y-3 lg:space-y-4">
              <h3
                className={`text-base sm:text-lg font-semibold ${theme.textPrimary} flex items-center space-x-2`}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3 lg:gap-4">
                ...
                <div className="sm:col-span-1 md:col-span-2 lg:col-span-1 xl:col-span-1">
                  ...
                  <input
                    ...
                    value={formData.sid}
                    onChange={(e) =>
                      handleInputChange("sid", e.target.value.toUpperCase())
                    }
        ...
        <div
          ...
          } p-3 sm:p-4 lg:p-5 flex justify-end space-x-3 shrink-0`}
        >
          <button
            onClick={onClose}
